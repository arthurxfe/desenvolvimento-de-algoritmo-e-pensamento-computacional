...
cálculo de consumo;
identificação de número par ou ímpar;
comparação entre valores;
cálculo de idade;
cálculo de potência.
O programa deverá permitir que o usuário selecione a operação desejada, informe os dados necessários e visualize o resultado correspondente.
